  ...
  return (
    <div className={[style.bgcolor_lightGrey, style.flex_grow_1].join(" ")}>
      <div className="container">
          <form className="row column-gap-3 row-gap-3 pt-5" onSubmit ={onSubmit} action="">
            ...
            <input onChange={(e)=>changeHandler(e)} type="text" className="col-2" name="slug" value={formData.slug} placeholder="inserisci testo"></input>
            <input onChange={(e)=>changeHandler(e)} type="text" className="col-2" name="content" value={formData.content} placeholder="inserisci contenuto"></input>
